...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-11104-LAPTOP-6V6JU18H/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog {
      ./.Xil/Vivado-11104-LAPTOP-6V6JU18H/realtime/Ins_ROM_stub.v
      ./.Xil/Vivado-11104-LAPTOP-6V6JU18H/realtime/data_RAM_stub.v
      ./.Xil/Vivado-11104-LAPTOP-6V6JU18H/realtime/display_0_stub.v
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-11104-LAPTOP-6V6JU18H/"
    if {$rt::useElabCache == false} {
